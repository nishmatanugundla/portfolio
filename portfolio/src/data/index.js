export const data = {
  ...
  summary: 'Front-End Developer with 6+ years of experience building scalable, responsive, and high-performance web applications using Angular, React, JavaScript, TypeScript,Redux, and NgRx. Experienced in enterprise-level payment and rewards applications, micro-frontend architecture, and accessibility-first development.',

  skills: [
    { cat: 'Frontend', items: ['Angular','React v16+', 'TypeScript', 'JavaScript ES6+', 'HTML5', 'CSS3', 'SASS'] },
    { cat: 'State', items: ['NgRx','Redux', 'React Query', 'Hooks', 'Context API'] },
    { cat: 'Testing', items: ['Jasmine','Jest', 'Karma','React Testing Library', 'Angular Testing Library'] },
  ...
  experience: [
    {
      ...
      skills: ['Angular', 'NgRx', 'TypeScript','AngularTestingLibrary', , 'Jenkins', 'Splunk', 'WCAG'],
      points: [
        ...
        'Managed complex state with NgRx selectors, reducers, and thunk-based async actions',
        'Built a caching layer using Angular HttpClient interceptors to eliminate redundant API calls',
        'Increased unit test coverage to 82% with Jasmine and Angular Testing Library',
    ...
    },
    {
      ...
      skills: ['Angular', 'NgRx', 'TypeScript', 'Jenkins', 'Splunk', 'WCAG'],
      points: [
        'Developed responsive single-page applications using Angular, TypeScript, RxJS, and modern JavaScript patterns',
        'Built reusable Angular components, custom directives, and utility services reducing duplicate implementation across modules',
        'Integrated REST APIs using Angular HttpClient with RxJS operators coordinated with Node.js backend services',
    ...
    },
    {
      ...
      skills: ['Angular', 'NgRx', 'TypeScript', 'Figma', 'Jenkins'],
      points: [
