    ...
    <section className="contact section" id="contact">
      <div className="section-inner">
        <div className="contact-grid">
          <div className="contact-left reveal" ref={ref1}>
            <span className="section-label">Get in Touch</span>
            <h2 className="contact-title">Let's work<br /><em>together.</em></h2>
            ...
            <div className="contact-links">
              <a href={`mailto:${data.email}`} className="contact-link">
                ...
                <div>
                  ...
                  <span className="contact-link-val">{data.email}</span>
                </div>
              </a>
              ...
              <a href={data.linkedin} target="_blank" rel="noreferrer" className="contact-link">
                ...
                <div>
                  ...
                  <span className="contact-link-val">nishmatanugundla</span>
                </div>
              </a>
          ...
          <div className="reveal" ref={ref2}>
            <span className="edu-section-label">Education</span>
            <div className="edu-cards">
              {data.education.map((edu) => (
                <div className="edu-card" key={edu.type}>
      ...
      <footer className="footer">
        <div className="footer-inner">
          <span className="footer-name">Nishma Tanugundla</span>
        </div>
      </footer>
    </section>
  )
